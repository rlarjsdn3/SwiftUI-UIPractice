...
class CityModel: ObservableObject {
    @Published var cities: [City] = testModel
}

var testModel: [City] = [
    City(name: "Madrid", country: "Spain", image: "madrid", favoriteCount: 7893, travelCount: 80234),
    ...
    City(name: "Seoul", country: "Mexico", image: "seoul", favoriteCount: 5921, travelCount: 1234),
